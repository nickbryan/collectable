...
func (c *identityServiceClient) CreateIdentity(ctx context.Context, in *CreateIdentityRequest, opts ...grpc.CallOption) (*CreateIdentityResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.iam.identity.service.v1.IdentityService/CreateIdentity", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _IdentityService_CreateIdentity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.iam.identity.service.v1.IdentityService/CreateIdentity",
	}
...
var IdentityService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.iam.identity.service.v1.IdentityService",
	...
	Metadata: "proto/iam/identity/service/v1/identity.proto",
}
